...
public class MIDLParser extends Parser {
	...
	public static final int
		...
		ID=39, INTEGER=40, FLOATING_PT=41, CHAR=42, STRING=43, BOOLEAN=44, WS=45, 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, "ID", "INTEGER", "FLOATING_PT", "CHAR", "STRING", "BOOLEAN", 
	...
	public final Member_listContext member_list() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 549772591072L) != 0)) {
				{
				{
				setState(90);
				type_spec();
